...
protected:  // used for condition
	...
	dag_size_t * _cache_stack;
public:
	CCDD_Manager( Variable max_var, dag_size_t estimated_node_num = LARGE_HASH_TABLE );
	CCDD_Manager( Chain & order, dag_size_t estimated_node_num = LARGE_HASH_TABLE );
